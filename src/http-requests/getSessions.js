...
export default function useGetSessions(user, refreshSessions) {
    ...
    const getSessions = async (user) => {
        ...
        try {
            ...
            const fetchedAllSessions = responseData.sessions;
            // Filter sessions
            const validSessions = fetchedAllSessions.filter((session) => {
                    ...
                    if (monthObj.month === month) {
                        monthObj.days.forEach((dayObj) => {
                            if (dayObj.day === dayOfMonth) {
                                todaysSessionsList.push(...dayObj.sessions);
                            }
                        });
                    }
                });
    ...
    return { allSessions, todaysSessions, sessionsLoading };
}
